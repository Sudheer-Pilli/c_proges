...
//inserting element at random position in the linked list
void randominsert()  
{  
    int i,loc,item;   
    struct node *ptr, *temp;  
...
//deleting element at the begining of the linked list
void begin_delete()  
{  
    struct node *ptr;  
    if(head == NULL)  
...
//deleting element at a random position in the linked list
void random_delete()  
{  
    struct node *ptr,*ptr1;  
    int loc,i;    
